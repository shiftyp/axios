...
import type { AxiosHeaderValue, RawAxiosHeaders } from '../../../index.d';
...
describe('AxiosHeaders', function () {
  ...
  describe('get', function () {
    describe('filter', function() {
      ...
      it('should support function', function () {
        ...
        assert.strictEqual(headers.get('foo', (value: AxiosHeaderValue, header: string) => {
  ...
  describe('has', function () {
    ...
    describe('filter', function () {
      ...
      it('should support function', function () {
        ...
        assert.strictEqual(headers.has('foo', (value: AxiosHeaderValue, header: string, headers: AxiosHeaders)=> {
          assert.strictEqual(value, 'bar=value1');
          assert.strictEqual(header, 'foo');
          return true;
        }), true);
  ...
  describe('delete', function () {
    ...
    describe('filter', function () {
      ...
      it('should support function', function () {
        ...
        headers.delete('foo', (value: AxiosHeaderValue, header: string)=> {
          assert.strictEqual(value, 'bar=value1');
          assert.strictEqual(header, 'foo');
          return false;
        });
  ...
  describe('should support parser headers from object with accessor', function () {
    it('parse plain object headers without constructor', function () {
      const thing = {
        'Set-Cookie': ['foo=bar', 'bar=baz']
      };

      const headers = new AxiosHeaders(thing);

      assert.strictEqual(headers.get('Set-Cookie')?.toString(), 'foo=bar, bar=baz');
    });
  });
});

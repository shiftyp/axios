...
describe('helpers::buildURL', function () {
  ...
  it('should support custom serialize function', function () {
    ...
    const options: ParamsSerializerOptions = {
      serialize: (thisParams: Record<string, any>, thisOptions?: ParamsSerializerOptions) => {
    ...
    const customSerializer = (thisParams: Record<string, any>) => {
      expect(thisParams).toEqual(params);
      return "rendered";
    };
